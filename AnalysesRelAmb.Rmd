...
[almost 83000 rows for the full dataset, due to multiple "gatherings"]
...
Check whether Subject needs to be factorial?

```{r Multilevel, options}

fitNull <- df_trials 

fitBase <- df_trials %>% filter(subjInclusion & Inclusion)
  lmer(logRT ~ primeType * targetType + (1 | Subject), data = ., REML = TRUE)
