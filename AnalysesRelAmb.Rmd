...
```{r Model with random slope for subject, options}
...
```{r model with only random intercept for subject, options}
...
```{r model without random intercept target, only random intercept Subject, options}
